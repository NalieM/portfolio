...
## Dane
Wykorzystany w projekcie zbiór danych Heart został opracowany na podstawie zestawu dostępnego pod adresem: https://archive.ics.uci.edu/ml/datasets/Heart+Disease. Zawiera wspomnianą wcześniej zmienną objaśnianą `target` oraz 13 zmiennych objaśniających: <br/>
...
![](https://github.com/NalieM/portfolio/blob/master/_posts/USwR_files/figure-html/unnamed-chunk-2-1.png "target variable")


![]({{ site.baseurl }}/_posts/USwR_files/figure-html/unnamed-chunk-2-1.png "target variable")
...
Analizując otrzymane rezultaty można stwierdzić, że: <br/>
