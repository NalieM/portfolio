...
## Dane
Wykorzystany w projekcie zbiór danych Heart został opracowany na podstawie zestawu dostępnego pod adresem: [Źródło danych](https://archive.ics.uci.edu/ml/datasets/Heart+Disease). Zawiera wspomnianą wcześniej zmienną objaśnianą `target` oraz 13 zmiennych objaśniających: <br/>
...
![]({{ site.baseurl }}/images/unnamed-chunk-2-1.png "target variable2")
